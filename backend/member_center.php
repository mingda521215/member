...
// count house_reside 
$count_reside = mysqli_query($db_link,'SELECT SUM(house_reside) from `fee2`');
  while($row = mysqli_fetch_array($count_reside)){
    $count_house_reside = $row['SUM(house_reside)'];
    }  

//檢查權限是否足夠
// if($_SESSION["memberLevel"]=="admin"){
// 	header("Location: member_center_old.php");
// }
//執行登出動作
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">住戶人數</span>
              <span class="info-box-number"><?php echo number_format($count_house_reside); ?><small>人</small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
