...
if(isset($_SESSION["loginMember"]) && ($_SESSION["loginMember"]!="")){
	...
	if($_SESSION["memberLevel"]=="member"){
		header("Location: backend/member_center.php");
	//否則則導向管理中心
	}else{
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg"><strong>請輸入您的帳號及密碼</strong></p>

    <form id="loginForm" method="post">
      <div class="form-group has-feedback">
      
        <input name="username" type="text" class="form-control" id="username" placeholder="帳號" value="<?php if(isset($_COOKIE["remUser"]) && ($_COOKIE["remUser"]!="")) echo $_COOKIE["remUser"];?>">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input name="passwd" type="password" id="passwd" class="form-control" placeholder="密碼" value="<?php if(isset($_COOKIE["remPass"]) && ($_COOKIE["remPass"]!="")) echo $_COOKIE["remPass"];?>">
    ...
    <a href="#">忘記密碼？</a>&nbsp;&nbsp;<a href="member_join.php">會員註冊</a><br>

  </div>
    <!-- 帳密不符，帶出 errMsg -->
    <?php if(isset($_GET["errMsg"]) && ($_GET["errMsg"]=="1")){?>
      <div class="alert alert-danger">請再次輸入正確的帳號及密碼</div>
    <?php }?>
